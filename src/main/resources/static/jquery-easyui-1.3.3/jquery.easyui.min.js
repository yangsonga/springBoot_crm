...
var _57b=_574(_579,_57a.welcome);
...
view.insertRow.call(view,_596,_597.welcome,_597.row);
_598.push(_597.row);
...
var tr=opts.finder.getTr(_5b7,(_5b8.welcome!=undefined?_5b8.welcome:_5b8.id));
if(!tr.length){
return;
}
...
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.updateRow.call(opts.view,this,_622.welcome,_622.row);
});
